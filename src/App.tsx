...
import { Phone, Mail, MapPin, Facebook, Twitter, Youtube, Instagram, ChevronDown } from 'lucide-react';
...
const cards = [
  [
    {
      title: (
        <h2 className="font-manrope text-2xl text-white">
          Grounded in science
        </h2>
      ),
      description: (
        <p className="font-poppins text-sm text-white">
          Our mental health care options are based on scientifically proven
          treatments & clinically validated approaches
        </p>
      ),
      logo: (
        <img src="/assets/why1.svg" alt="Logo" className="w-12 h-12 filter invert" />
      ),
    ...
    },
    {
      ...
      logo: (
        <img src="/assets/why2.svg" alt="Logo" className="w-12 h-12 filter invert" />
      ),
      color: 'bg-gradient-to-r from-emerald-500 via-emerald-600 to-emerald-700 text-white',
    },
    {
      ...
      logo: (
        <img src="/assets/why3.svg" alt="Logo" className="w-12 h-12 filter invert" />
      ),
      color: 'bg-gradient-to-r from-emerald-500 via-emerald-600 to-emerald-700 text-white',
    },
    {
      ...
      logo: (
        <img src="/assets/why4.svg" alt="Logo" className="w-12 h-12 filter invert" />
      ),
      color: 'bg-gradient-to-r from-emerald-500 via-emerald-600 to-emerald-700 text-white',
    },
  ]
...
function HomePage() {
  ...
  const [offeringsRef, offeringsInView] = useInView({
    triggerOnce: true,
    threshold: 0.1
  });
    ...
    <div className="bg-[url('/assets/lines.png')] bg-cover bg-no-repeat bg-fixed min-h-screen z-10">
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-manrope font-bold mb-6">
                The <span className="text-coral-500">Number One</span>
                <br />Mental Health Benefit
              </h1>
              <p className="font-poppins font-bold text-gray-600 mb-8">
                Dedicated to help people navigate in life while with 100% of wellness.
                We're the pioneer in avoiding employee burnout, improving productivity, and
        ...
        >
          ...
          <h3 className="font-manrope text-center text-4xl font-bold mb-12">
            Why Our Mental Health Therapy are the Best Choice
          </h3>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h3 className="font-manrope text-left text-4xl font-bold mb-12">
                Our Mental Health Care
                <br />
                <span className="text-customOrange">Offerings</span>
              </h3>
              <p className="text-black font-poppins mb-8 text-sm">
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  className="absolute inset-0 bg-black/60 flex flex-col justify-center items-center p-6 text-white"
                >
                  ...
                  <button className="mt-4 bg-coral-500 text-white px-8 py-3 rounded-full hover:bg-coral-600 w-fit text-center">
                    Get Started
                  </button>
                </motion.div>
              </motion.div>
      ...
      <nav className="bg-white shadow-sm relative z-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="font-poppins flex gap-8 items-center">
              <Link to="/" className="hover:text-customOrange">Home</Link>
              <div className="relative">
                <button 
                  className="flex items-center gap-1 hover:text-customOrange focus:outline-none"
            ...
            <Link to="#" className="bg-customOrange text-white px-6 py-2 rounded-full hover:bg-hoverOrange">
              Contact Us
            </Link>
          </div>
        </div>
        ...
        {showServicesMenu && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              transition={{ duration: 0.2 }}
              className="absolute top-16 left-1/2 transform -translate-x-1/2 bg-white rounded-lg shadow-xl z-50 w-[400px] overflow-hidden"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-sm opacity-80">
                Empowering you to find peace of mind and emotional well-being through support, guidance, and understanding
              </p>
            </div>
